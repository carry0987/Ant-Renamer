...
type
  TAntJvTextOption = (toCaption, toFormat, toNoText, toPercent);

  TAntJvSpecialProgress = class(TGraphicControl)
  private
    ...
    procedure SetTextOption(const Value: TAntJvTextOption);
  ...
  published
    ...
    property TextOption: TAntJvTextOption read FTextOption write SetTextOption default toNoText;
    property Visible;
    property OnClick;
    property OnDblClick;
    property OnDragOver;
...
constructor TAntJvSpecialProgress.Create(AOwner: TComponent);
begin
...
destructor TAntJvSpecialProgress.Destroy;
begin
  FBuffer.Free;
  inherited Destroy;
end;

procedure TAntJvSpecialProgress.CMColorChanged(var Msg: TMessage);
begin
...
procedure TAntJvSpecialProgress.CMFontChanged(var Msg: TMessage);
begin
  { No need to call inherited; Repaint is called in UpdateBuffer }
...
procedure TAntJvSpecialProgress.CMParentColorChanged(var Msg: TMessage);
begin
  inherited;
...
procedure TAntJvSpecialProgress.CMTextChanged(var Msg: TMessage);
begin
  { No need to call inherited; Repaint is called in UpdateBuffer }
...
function TAntJvSpecialProgress.GetPercentDone: Longint;
begin
...
procedure TAntJvSpecialProgress.Loaded;
begin
  inherited Loaded;
  UpdateTaille;
  UpdateBuffer;
...
procedure TAntJvSpecialProgress.MouseEnter(var Msg: TMessage);
begin
...
procedure TAntJvSpecialProgress.MouseLeave(var Msg: TMessage);
begin
...
procedure TAntJvSpecialProgress.Paint;
begin
...
procedure TAntJvSpecialProgress.PaintBackground;
begin
...
procedure TAntJvSpecialProgress.PaintNonSolid;
var
...
procedure TAntJvSpecialProgress.PaintRectangle;
var
  Rect: TRect;
begin
  Rect := ClientRect;
...
procedure TAntJvSpecialProgress.PaintSolid;
var
...
procedure TAntJvSpecialProgress.PaintText;
var
  S: string;
  X, Y: Integer;
  LTaille: Integer;
...
procedure TAntJvSpecialProgress.SetBorderStyle(Value: TBorderStyle);
begin
...
procedure TAntJvSpecialProgress.SetEndColor(const Value: TColor);
begin
...
procedure TAntJvSpecialProgress.SetGradientBlocks(const Value: Boolean);
begin
...
procedure TAntJvSpecialProgress.SetMaximum(const Value: Integer);
var
...
procedure TAntJvSpecialProgress.SetMinimum(const Value: Integer);
var
  OldPercentageDone: Integer;
begin
...
procedure TAntJvSpecialProgress.SetPosition(const Value: Integer);
var
  OldPercentageDone: Integer;
begin
  if FPosition <> Value then
...
procedure TAntJvSpecialProgress.SetSolid(const Value: Boolean);
begin
...
procedure TAntJvSpecialProgress.SetStartColor(const Value: TColor);
begin
...
procedure TAntJvSpecialProgress.SetTextCentered(const Value: Boolean);
begin
...
procedure TAntJvSpecialProgress.SetTextOption(const Value: TAntJvTextOption);
begin
...
procedure TAntJvSpecialProgress.StepIt;
begin
...
procedure TAntJvSpecialProgress.UpdateBuffer;
begin
...
procedure TAntJvSpecialProgress.UpdateTaille;
var
  NewTaille: Integer;
